    ...
    <section class="product_description_area">
        <div class="container">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="contact-face-tab" data-toggle="tab" href="#contactFace" role="tab"
                       aria-controls="contactFace"
                       aria-selected="false">{{ __('messages.comment-facebook') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab"
                       aria-controls="contact"
                       aria-selected="false">{{ __('messages.comments') }}</a>
                </li>
                <li class="nav-item">
                        ...
                        <div class="col-lg-6">
                            <div class="comment_list">
                                <div class="review_item">
                                    <div class="media">
                                        <div class="d-flex">
                                            <img src="{{ asset('theme_home') }}/img/product/single-product/review-1.png"
                                                 alt=""/>
                                        </div>
                                ...
                                <div class="review_item reply">
                                    <div class="media">
                                        <div class="d-flex">
                                            <img src="{{ asset('theme_home') }}/img/product/single-product/review-2.png"
                                                 alt=""/>
                                        </div>
                                        <div class="media-body">
                                            <h4>Blake Ruiz</h4>
                                ...
                                <div class="review_item">
                                    <div class="media">
                                        <div class="d-flex">
                                            <img src="{{ asset('theme_home') }}/img/product/single-product/review-3.png"
                                                 alt=""/>
                                        </div>
                                        <div class="media-body">
                                            <h4>Blake Ruiz</h4>
