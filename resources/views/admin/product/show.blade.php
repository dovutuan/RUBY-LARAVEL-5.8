                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active"
                                            aria-current="page">{{ __('messages.a-product-detail') }}</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                        ...
                                        <div class="card1">
                                            <div class="card1-body">
                                                ...
                                                <div class="form-group">
                                                    <label
                                                        class="control-label"><b>{{ __('messages.a-name') }}</b></label>
                                        ...
                                        <div class="card1">
                                            <div class="card1-body">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <img src="{{fileUrl(PRODUCTS, $product->image)}}"
                                                                 class="img-fluid rounded">
                                                        </div>
                                                        @if($product->img)
                                                            @foreach($product->img->image as $image)
                                                                <div class="col-md-2">
                                                                    <img src="{{fileUrl(PRODUCTS, $image)}}"
                                                                         class="img-fluid rounded">
                                                                </div>
                                                            @endforeach
                                                        @endif
                                                ...
                                                @foreach($product->optionProduct as $optionProduct)
                                                    <div class="row">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <div class="input-group-append">
                                                                        <input class="form-control" type="text"
                                                                               value="{{$optionProduct->species->name}}"
                                                                               Disabled>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label
                                                                    class="control-label"><b>{{ __('messages.a-pay') }}</b></label>
                                                                <input class="form-control" type="text"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    <input type="text" class="form-control"
                                                                           value="{{number_format($optionProduct->price)}}"
                                                                           Disabled>
                                                                    <div class="input-group-append">
                                                ...
                                                <div class="card1-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label
                                                                    class="control-label"><b>{{ __('messages.a-sale') }}</b></label>
                                                                <div class="input-group mb-3">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label
                                                                    class="control-label"><b>{{ __('messages.a-start') }}</b></label>
